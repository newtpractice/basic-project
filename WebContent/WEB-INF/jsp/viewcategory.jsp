        ...
        <tbody>
            <c:forEach items="${products}" var="book">
                <tr>
                    ...
                    <td><a href="editproduct?id=<c:out value="${book.productid}"/>"> Edit</a></td>
                    <td><a href="deleteproduct?id=<c:out value="${book.productid}"/>"> Delete</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
...
<center>
<a href="addproduct?id=<c:out value="${categoryid}"/>"> Add New Product</a></td>
</center>
